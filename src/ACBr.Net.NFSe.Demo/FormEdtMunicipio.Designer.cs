namespace ACBr.Net.NFSe.Demo
{
	partial class FormEdtMunicipio
	{
		...
		private void InitializeComponent()
		{
			...
			// btnSalvar
			// 
			this.btnSalvar.Location = new System.Drawing.Point(627, 310);
			...
			// btnCancelar
			// 
			this.btnCancelar.Location = new System.Drawing.Point(546, 310);
			...
			this.txtMunicipio.Size = new System.Drawing.Size(292, 20);
			this.txtMunicipio.TabIndex = 3;
			// 
			// txtUF
			// 
			this.txtUF.Location = new System.Drawing.Point(310, 25);
			...
			this.tabControl1.Size = new System.Drawing.Size(684, 233);
			...
			this.tabPage1.Size = new System.Drawing.Size(676, 207);
			...
			this.txtHConsultarSequencialRps.TabIndex = 20;
			// 
			// label9
			// 
			...
			this.txtHConsultrLoteRps.TabIndex = 14;
			// 
			// label7
			// 
			...
			this.txtHConsultaNFSe.TabIndex = 12;
			// 
			// label8
			// 
			...
			this.txtHEnviarSincrono.TabIndex = 10;
			// 
			// label5
			// 
			...
			this.txtHCancelaNFSe.TabIndex = 6;
			// 
			// label3
			// 
			...
			this.tabPage2.Size = new System.Drawing.Size(676, 207);
			...
			this.txtPConsultarSequencialRps.TabIndex = 38;
			// 
			// label13
			// 
			...
			this.txtPConsultrLoteRps.TabIndex = 32;
			// 
			// label16
			// 
			...
			this.txtPConsultaNFSe.TabIndex = 30;
			// 
			// label17
			// 
			...
			this.txtPEnviarSincrono.TabIndex = 28;
			// 
			// label18
			// 
			...
			this.txtPCancelaNFSe.TabIndex = 24;
			// 
			// label20
			// 
			...
			this.groupBox1.Size = new System.Drawing.Size(690, 252);
